                        ...
                        <form
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" defaultValue={data?.name} {...register('name')} id="product-name" className="shadow-sm border border-gray-300 text-gray-900 sm:text-base rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 font-raj" placeholder="Enter your item name" required="" />
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="">
                                        ...
                                        <select id="category" value={data.category} {...register('category')} className="bg-white border border-gray-300 text-[#3e454c] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400 ">
                                    ...
                                    <div className="">
                                        ...
                                        <input type="number" defaultValue={data?.price} {...register('price')} id="price" className="shadow-sm border border-gray-300 text-gray-900 sm:text-base font-raj rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="$2300" required="" />
                                    </div>
                                </div>
                                ...
                                <div className="">
                                    ...
                                    <textarea id="product-details" defaultValue={data?.recipe} {...register('recipe')} rows="6" className="border border-gray-300 text-gray-900 sm:text-base font-raj rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" placeholder="Details"></textarea>
                                </div>
                            ...
                            <div className="font-inter max-w-md">
                                ...
                                <input type="file" defaultValue={data?.image} {...register('image')}
